...
# Serve aid transfers frontend
@app.get("/aid-transfers", response_class=HTMLResponse)
async def get_aid_transfers_page():
    with open("static/aid-transfers.html", "r") as f:
        return f.read()

# API endpoint for aid transfers
